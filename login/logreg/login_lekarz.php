 ...
 */
    /** Start sesji lekarza */
    session_start();
    /** Sprawdzenie czy istnieje sesja, jeśli tak przeniesienie do panelu lekarza */
    if((isset($_SESSION["zalogowany_pracownicy"])) && ($_SESSION["zalogowany_pracownicy"]==true)){
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="login_checker_prac.php">
